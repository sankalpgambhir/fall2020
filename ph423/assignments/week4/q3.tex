...
\question*{Consider the isotropic three dimensional harmonic oscillator under the influence of the perturbation $H^{'} = \lambda x^2yz$. Discuss the effect of the perturbation on the ground state and the first excited state of the isotropic oscillator.}

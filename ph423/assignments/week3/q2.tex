  \parth{doing question 2. Someone go through afterwards}
    ...
    %\question*{Calculate the variational bound on the ground state energy of the
    %Hydrogen atom using the trial wavefunction
    %\begin{equation*}
    %    \psi_{\alpha}(r) = 
    %    \begin{cases}
    ...
    We need to find out what the action on the Hamiltonian operator on our trial
    wavefunction is.
